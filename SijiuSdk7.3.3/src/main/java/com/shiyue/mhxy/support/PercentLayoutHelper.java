...
package com.shiyue.mhxy.support;
 ...
 * {@link PercentLayoutHelper.PercentLayoutParams}.
 ...
 * method that you implemented for {@link PercentLayoutHelper.PercentLayoutParams} interface.
 * <li> Override
...
//    以下是针对为标签定义的子代码编程的资源ID的解决方案：
    ...
    public static final int getStyleableIntArrayIndex(Context context,String name) {
        try {
            if (context == null)
                return 0;
            // use reflection to access the resource class
     ...
     */
    public static PercentLayoutInfo getPercentLayoutInfo(Context mcontext,
                                                         AttributeSet attrs)
    {
        context=mcontext;
        PercentLayoutInfo info = null;
       int [] arr= getResourceDeclareStyleableIntArray(context,"PercentLayout_Layout");
        int attrId = context.getResources().getIdentifier("PercentLayout_Layout", "attr", context.getPackageName());
        TypedArray array =  context.obtainStyledAttributes(attrs, arr);
...
//        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array, context.getResources().getIdentifier("PercentLayout_Layout_layout_widthPercent", "styleable", context.getPackageName()), true);
        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array,getStyleableIntArrayIndex(context,"PercentLayout_Layout_layout_widthPercent"), true);
        if (percentVal != null)
        {
        ...
        percentVal =  getPercentVal(array,getStyleableIntArrayIndex(context,"PercentLayout_Layout_layout_heightPercent"), false);
//        percentVal = getPercentVal(array, context.getResources().getIdentifier("PercentLayout_Layout_layout_heightPercent", "styleable", context.getPackageName()), false);
//        percentVal = getPercentVal(array, R.styleable.PercentLayout_Layout_layout_heightPercent, false);
    ...
    private static PercentLayoutInfo setTextSizeSupportVal(TypedArray array, PercentLayoutInfo info)
    {
        //textSizePercent 默认以高度作为基准
           ...
           PercentLayoutInfo.PercentVal percentVal = getPercentVal(array,getStyleableIntArrayIndex(context,"PercentLayout_Layout_layout_textSizePercent"), false);
...
//        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array, context.getResources().getIdentifier("PercentLayout_Layout_layout_textSizePercent", "styleable", context.getPackageName()), false);
        if (percentVal != null)
        {
            if (Log.isLoggable(TAG, Log.VERBOSE))
            {
    ...
    {
        //maxWidth
        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array,getStyleableIntArrayIndex(context,"PercentLayout_Layout_layout_maxWidthPercent"), true);
//        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array,
//                context.getResources().getIdentifier("PercentLayout_Layout_layout_maxWidthPercent", "styleable", context.getPackageName()),
//                true);
        if (percentVal != null)
        {
            info = checkForInfoExists(info);
        ...
        //maxHeight
        percentVal =getPercentVal(array,getStyleableIntArrayIndex(context,"PercentLayout_Layout_layout_maxHeightPercent"), false);
//        percentVal = getPercentVal(array,
//                context.getResources().getIdentifier("PercentLayout_Layout_layout_maxHeightPercent", "styleable", context.getPackageName()),
//                false);
        if (percentVal != null)
        {
            info = checkForInfoExists(info);
        ...
        //minWidth
        percentVal =getPercentVal(array,getStyleableIntArrayIndex(context,"PercentLayout_Layout_layout_minWidthPercent"), true);
//        percentVal = getPercentVal(array,
//                context.getResources().getIdentifier("PercentLayout_Layout_layout_minWidthPercent", "styleable", context.getPackageName()),
//                true);
        if (percentVal != null)
        {
            info = checkForInfoExists(info);
        ...
        //minHeight
        percentVal =getPercentVal(array,getStyleableIntArrayIndex(context,"PercentLayout_Layout_layout_minHeightPercent"), false);
//        percentVal = getPercentVal(array,
//                context.getResources().getIdentifier("PercentLayout_Layout_layout_minHeightPercent", "styleable", context.getPackageName()),
//                false);
        if (percentVal != null)
        {
            info = checkForInfoExists(info);
    ...
    private static PercentLayoutInfo setMarginRelatedVal(TypedArray array, PercentLayoutInfo info)
    {
        ...
        PercentLayoutInfo.PercentVal percentVal =
                getPercentVal(array,getStyleableIntArrayIndex(context,"PercentLayout_Layout_layout_marginPercent"), true);
//        PercentLayoutInfo.PercentVal percentVal =
//                getPercentVal(array,
//                        context.getResources().getIdentifier("PercentLayout_Layout_layout_marginPercent", "styleable", context.getPackageName()),
//                        true);
        ...
        percentVal =getPercentVal(array,getStyleableIntArrayIndex(context,"PercentLayout_Layout_layout_marginLeftPercent"), true);
//        percentVal = getPercentVal(array,context.getResources().getIdentifier("PercentLayout_Layout_layout_marginLeftPercent", "styleable", context.getPackageName()), true);
        if (percentVal != null)
        {
            if (Log.isLoggable(TAG, Log.VERBOSE))
            {
        ...
        percentVal =getPercentVal(array,getStyleableIntArrayIndex(context,"PercentLayout_Layout_layout_marginTopPercent"), false);
//        percentVal = getPercentVal(array,  context.getResources().getIdentifier("PercentLayout_Layout_layout_marginTopPercent", "styleable", context.getPackageName()), false);
        if (percentVal != null)
        {
            if (Log.isLoggable(TAG, Log.VERBOSE))
            {
        ...
        percentVal =getPercentVal(array,getStyleableIntArrayIndex(context,"PercentLayout_Layout_layout_marginRightPercent"), true);
//        percentVal = getPercentVal(array,   context.getResources().getIdentifier("PercentLayout_Layout_layout_marginRightPercent", "styleable", context.getPackageName()), true);
        if (percentVal != null)
        {
            if (Log.isLoggable(TAG, Log.VERBOSE))
            {
        ...
        percentVal =getPercentVal(array,getStyleableIntArrayIndex(context,"PercentLayout_Layout_layout_marginBottomPercent"), false);
//        percentVal = getPercentVal(array,  context.getResources().getIdentifier("PercentLayout_Layout_layout_marginBottomPercent", "styleable", context.getPackageName()), false);
        if (percentVal != null)
        {
            if (Log.isLoggable(TAG, Log.VERBOSE))
            {
        ...
        percentVal =getPercentVal(array,getStyleableIntArrayIndex(context,"PercentLayout_Layout_layout_marginStartPercent"), true);
//        percentVal = getPercentVal(array, context.getResources().getIdentifier("PercentLayout_Layout_layout_marginStartPercent", "styleable", context.getPackageName()), true);
        if (percentVal != null)
        {
            if (Log.isLoggable(TAG, Log.VERBOSE))
            {
        ...
        percentVal =getPercentVal(array,getStyleableIntArrayIndex(context,"PercentLayout_Layout_layout_marginEndPercent"), true);
//        percentVal = getPercentVal(array, context.getResources().getIdentifier("PercentLayout_Layout_layout_marginEndPercent", "styleable", context.getPackageName()), true);
        if (percentVal != null)
        {
            if (Log.isLoggable(TAG, Log.VERBOSE))
            {
    ...
    {
        //默认padding以宽度为标准
        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array,getStyleableIntArrayIndex(context,"PercentLayout_Layout_layout_paddingPercent"), true);
//        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array,
//                context.getResources().getIdentifier("PercentLayout_Layout_layout_paddingPercent", "styleable", context.getPackageName()),
//                true);
        if (percentVal != null)
        {
            info = checkForInfoExists(info);
        ...
        percentVal = getPercentVal(array,getStyleableIntArrayIndex(context,"PercentLayout_Layout_layout_paddingLeftPercent"), true);
//        percentVal = getPercentVal(array,
//                context.getResources().getIdentifier("PercentLayout_Layout_layout_paddingLeftPercent", "styleable", context.getPackageName())  ,
//                true);
        if (percentVal != null)
        {
            info = checkForInfoExists(info);
        ...
        percentVal = getPercentVal(array,getStyleableIntArrayIndex(context,"PercentLayout_Layout_layout_paddingRightPercent"), true);
//        percentVal = getPercentVal(array,
//                context.getResources().getIdentifier("PercentLayout_Layout_layout_paddingRightPercent", "styleable", context.getPackageName()),
//                true);
        if (percentVal != null)
        {
            info = checkForInfoExists(info);
        ...
        percentVal = getPercentVal(array,getStyleableIntArrayIndex(context,"PercentLayout_Layout_layout_paddingTopPercent"), true);
//        percentVal = getPercentVal(array,
//                context.getResources().getIdentifier("PercentLayout_Layout_layout_paddingTopPercent", "styleable", context.getPackageName()),
//                true);
        if (percentVal != null)
        {
            info = checkForInfoExists(info);
        ...
        percentVal = getPercentVal(array,getStyleableIntArrayIndex(context,"PercentLayout_Layout_layout_paddingBottomPercent"), true);
//        percentVal = getPercentVal(array,
//                context.getResources().getIdentifier("PercentLayout_Layout_layout_paddingBottomPercent", "styleable", context.getPackageName()),
//                true);
        if (percentVal != null)
        {
            info = checkForInfoExists(info);
